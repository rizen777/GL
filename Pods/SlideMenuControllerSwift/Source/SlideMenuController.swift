    ...
    public func addLeftGestures() {
        ...
        if (leftViewController != nil) {
            if leftPanGesture == nil {
                leftPanGesture = UIPanGestureRecognizer(target: self, action: Selector("handleLeftPanGesture:"))
    ...
    public func addRightGestures() {
        ...
        if (rightViewController != nil) {
            if rightPanGesture == nil {
                rightPanGesture = UIPanGestureRecognizer(target: self, action: Selector("handleRightPanGesture:"))
